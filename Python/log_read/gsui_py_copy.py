...
"}")
        ...
        self.horizontalLayout_4 = QGridLayout()
        self.horizontalLayout_4.setObjectName(u"horizontalLayout_4")
        self.plot_speed = QSlider(self.centralwidget)
        self.plot_speed.setObjectName(u"plot_speed")
        self.left_bound = QSlider(self.centralwidget)
        self.left_bound.setObjectName(u"left_bound")
        self.right_bound = QSlider(self.centralwidget)
        self.right_bound.setObjectName(u"right_bound")
        self.scroll = QSlider(self.centralwidget)
        ...
        self.horizontalLayout_4.addWidget(self.plot_speed,1,0)

        sizePolicy.setHeightForWidth(self.left_bound.sizePolicy().hasHeightForWidth())
        self.left_bound.setSizePolicy(sizePolicy)
        self.left_bound.setMinimumSize(QSize(250, 0))
        self.left_bound.setMinimum(0)
        self.left_bound.setMaximum(1000)
        self.left_bound.setValue(0)
        self.left_bound.setOrientation(Qt.Horizontal)
        self.left_bound.setTickInterval(0.5)

        self.horizontalLayout_4.addWidget(self.left_bound,1,1)

        sizePolicy.setHeightForWidth(self.right_bound.sizePolicy().hasHeightForWidth())
        self.right_bound.setSizePolicy(sizePolicy)
        self.right_bound.setMinimumSize(QSize(250, 0))
        self.right_bound.setMinimum(0)
        self.right_bound.setMaximum(1000)
        self.right_bound.setValue(1000)
        self.right_bound.setOrientation(Qt.Horizontal)
        self.right_bound.setTickInterval(1)

        self.horizontalLayout_4.addWidget(self.right_bound,3,1)

        sizePolicy.setHeightForWidth(self.scroll.sizePolicy().hasHeightForWidth())
        self.scroll.setSizePolicy(sizePolicy)
        self.scroll.setMinimumSize(QSize(250, 0))
        self.scroll.setMinimum(0)
        self.scroll.setMaximum(1000)
        self.scroll.setValue(500)
        self.scroll.setOrientation(Qt.Horizontal)
        self.scroll.setTickInterval(1)

        self.horizontalLayout_4.addWidget(self.scroll,2,1)
...
"")
        ...
        self.horizontalLayout_4.addWidget(self.label_9,1,2)
...
"")
        ...
        self.read_button.setStyleSheet(u"QPushButton#read_button {\n"
"	background-color: rgb(85, 170, 255);\n"
"	border: none;\n"
"	color: rgb(255, 255, 255);\n"
"	border-radius: 5px;\n"
...
"}\n"
"\n"
"QPushButton#read_button:pressed {\n"
"	background-color: rgb(85, 170, 0);\n"
"	border: none;\n"
"	color: rgb(255, 255, 255);\n"
"	border-radius: 5px;\n"
...
"")
        ...
        self.gridLayout_6.addWidget(self.read_button, 4, 0, 1, 2)
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.read_button.setText(QCoreApplication.translate("MainWindow", u"Read From File", None))
